...
<head>
    ...
    <title>Admin zone - Newsletter</title>
</head>
<body>
    ...
    <section>
        <form name="form_email" action="admin_send_email.php" method="POST">
            <label for="txtarea">Newsletter content</label><br>
            <textarea name="txtarea" id="txtarea" cols="60" rows="20"></textarea>
            <br><br>
            <input type="submit">
        </form>
    </section>
