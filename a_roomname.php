...
<?php
    $sql_room_names = "
            ...
            FROM
                room_names
            order by
                room_names.room_name_id
    ";
    $result = $conn->query($sql_room_names);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <section class='add'>
        <a class='addroomname' href="admin_insert_roomname.php">Add room name</a>
    </section>
    <section>
        <table border=1>
            <thead>
                <tr>
                    <th>Room name id</th>
                    <th>Room name</th>
                    <th>Room name point</th>
                    <th>Room name price</th>
                    <th>Edit</th>
                    <th>Delete</th>
                </tr>
            </thead>
            ...
            <?php
                foreach($result as $value) {
                    echo "<tr>
                            ...
                            <td><a href='admin_edit_roomname.php?id={$value['room_name_id']}&action=edit'>Edit</a></td>
                            <td><a href='admin_r_form5.php?id={$value['room_name_id']}&action=delete'>Delete</a></td>
                        </tr>";
                }
            ?>
            </tbody>
