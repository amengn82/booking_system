...
<head>
    ...
    <title>Admin zone - Insert room status</title>
</head>
<body>
    ...
    <section>
        <h1>Room status insert form</h1><br>
        <form action="admin_r_form6.php" method="POST">

            <label for="room_status_name">Room status :</label><br>
            <input type="text" name="room_status_name" id="room_status_name" required><br><br>
