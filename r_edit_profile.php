...
<head>
    ...
    <title>Profile edit result</title>
</head>
<body>
    ...
    <section>
        ...
        if(isset($_GET['id']) && $_GET['action'] == 'edit') {
            if(is_uploaded_file($temp)) {
                ...
                echo "<a href='profile.php'>Back to user page</a>";
                }
        // Delete หากเปิดบรรทัดนี้จะเป็นการอนุญาตให้ user สามารถลบ account ของตัวเองได้
        ...
        //echo "<a href='login.php'>Back to user page</a>";
        //}   
        ?>
    </section>
