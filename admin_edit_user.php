...
<?php
    ...
    //รับค่า
        ...
        //ดึงค่าออกจาก $result และเก็บค่าไว้ในตัวแปรที่กำหนด
...
<head>
    ...
    <title>Admin zone - Edit users</title>
</head>
<body>
    ...
    <section>
        <h1>Profile edit form</h1><br>
        <form action="admin_r_form1.php?id=<?php echo $id; ?>&action=edit" method="POST" enctype="multipart/form-data">
            <label for="profile_image">Profile image</label><br>
            <input type="file" name="profile_image" id="profile_image"><br><br>
            <input type="hidden" name="hidden_prof_img" id="hidden_prof_img" value="<?php echo isset($profile_image)?$profile_image:''; ?>" 
            required><br>
            ...
            <input type="text" name="firstname" id="firstname" value="<?php echo isset($firstname)?$firstname:''; ?>" required><br><br>

            <label for="lastname">Lastname :</label><br>
            <input type="text" name="lastname" id="lastname" value="<?php echo isset($lastname)?$lastname:''; ?>" required><br><br>

            <label for="birthdate">Birthdate :</label><br>
            <input type="date" name="birthdate" id="birthdate" value="<?php echo isset($birthdate)?$birthdate:''; ?>" required><br><br>
