...
<?php
    $sql_benefits = "
            ...
            FROM
                benefits
    ";
    $result = $conn->query($sql_benefits);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <section class='add'>
        <a class='addbenefit' href="admin_insert_benefit.php">Add benefit</a>
    </section>
    <section>
        <table border=1>
            <thead>
            ...
            <?php
                foreach($result as $value) {
                    echo "<tr>
                            ...
                            <td><a href='admin_edit_benefit.php?id={$value['benefit_id']}&action=edit'>Edit</a></td>
                            <td><a href='admin_r_form10.php?id={$value['benefit_id']}&action=delete'>Delete</a></td>
                        </tr>";
                }
            ?>
            </tbody>
