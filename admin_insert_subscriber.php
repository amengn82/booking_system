...
<head>
    ...
    <title>Admin zone - Insert subscribers</title>
</head>
<body>
    ...
    <section>
        <h1>Subscriber insert form</h1><br>
        <form action="admin_r_form2.php" method="POST">
            <label for="user_id">Enter user id to add more subscribers</label><br>
            <input type="number" name="user_id" id="user_id" placeholder="user id here" required>
