...
<body>
    ...
    <h1>Payroll summary report</h1><br>
        <form action="admin_r_payroll.php" method="POST">

        <label for="salarydate">Salary date :</label><br>
        <input type="date" name="salarydate" id="salarydate">
        <br><br>
