...
<body>
    ...
    <section>
        ...
        <form action="admin_r_form8.php?id=<?php echo $id; ?>&check_in=<?php echo $checkin; ?>&check_out=<?php echo $checkout; ?> &action=book" method="POST">

            <label for="user_id">User id :</label><br>
            <input type="numnber" name="user_id" id="user_id"><br><br>

            <label for="room_id">Room id :</label><br>
            <input type="number" name="room_id" id="room_id" value="<?php echo isset($id)?$id:''; ?>"><br><br>

            <label for="check_in">Check in :</label><br>
            <input type="date" name="check_in" id="check_in" value="<?php echo isset($checkin)?$checkin:''; ?>"><br><br>

            <label for="check_out">Check out :</label><br>
            <input type="date" name="check_out" id="check_out" value="<?php echo isset($checkout)?$checkout:''; ?>"><br><br>
